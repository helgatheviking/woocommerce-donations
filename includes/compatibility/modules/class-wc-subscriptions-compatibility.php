...
/**
 * WC_Donations_Subscriotions_Compatibility Class.
 *
 * Adds compatibility with WooCommerce Points and Rewards.
 */
class WC_Donations_Subscriotions_Compatibility {

	/**
	 * MnM points - @see 'WC_Donations_Subscriotions_Compatibility::replace_points'.
	 * @var mixed
	 */
...
WC_Donations_Subscriotions_Compatibility::init();
